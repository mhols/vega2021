...
starname = 'betaCrB'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '01may23_betaCrB/NEO_20230501_153151_th0.fits')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '01may23_betaCrB/NEO_20230501_220549_st0.fits')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '01may23_betaCrB/NEO_20230501_220648_st0.fits')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '01may23_betaCrB/NEO_20230501_220740_st0.fits')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '01may23_betaCrB/NEO_20230501_220833_st0.fits')
