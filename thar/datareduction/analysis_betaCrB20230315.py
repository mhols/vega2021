...
starname = 'betaCrB'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '15mar23_betaCrB/NEO_20230315_180154_th0')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '15mar23_betaCrB/NEO_20230316_051445_st0')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '15mar23_betaCrB/NEO_20230316_051539_st0')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '15mar23_betaCrB/NEO_20230316_051631_st0')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '15mar23_betaCrB/NEO_20230316_051725_st0')
