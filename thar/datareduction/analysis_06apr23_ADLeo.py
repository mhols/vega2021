...
starname = 'ADLeo'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '06apr23_ADLeo/NEO_20230406_190457_th0.fits')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '06apr23_ADLeo/NEO_20230406_215211_st0.fits')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '06apr23_ADLeo/NEO_20230406_221242_st0.fits')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '06apr23_ADLeo/NEO_20230406_223307_st0.fits')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '06apr23_ADLeo/NEO_20230406_225333_st0.fits')
