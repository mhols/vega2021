...
starname = 'betaCrB'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '19apr23_betaCrB/NEO_20230419_210452_th0.fits')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '19apr23_betaCrB/NEO_20230419_215234_st0.fits')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '19apr23_betaCrB/NEO_20230419_215327_st0.fits')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '19apr23_betaCrB/NEO_20230419_215419_st0.fits')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '19apr23_betaCrB/NEO_20230419_215512_st0.fits')
