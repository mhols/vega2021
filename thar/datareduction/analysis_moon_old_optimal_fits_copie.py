...
starname = 'moon'
fitsfile_tharname = os.path.join(kwargs_moon['BASEDIR'], 'lune_raw/NEO_20200202_173811_th0.fits')
starname_1 = os.path.join(kwargs_moon['BASEDIR'], 'lune_raw/NEO_20200202_182606_st0.fits')
starname_2 = os.path.join(kwargs_moon['BASEDIR'], 'lune_raw/NEO_20200202_182642_st0.fits')
starname_3 = os.path.join(kwargs_moon['BASEDIR'], 'lune_raw/NEO_20200202_182715_st0.fits')
starname_4 = os.path.join(kwargs_moon['BASEDIR'], 'lune_raw/NEO_20200202_182751_st0.fits')

# the following lines may be commented out when done..


kwargs_moon['SETTING_ID'] = 'MOON'
kwargs_moon['HIGHEXP'] = '15'
kwargs_moon['LOWEXP'] = '4'
...
with open(str(starname)+"old_int.s","w") as f:
