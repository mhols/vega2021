...
starname = 'betaCrB'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '02may23_betaCrB/NEO_20230502_190048_th0.fits')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '02may23_betaCrB/NEO_20230503_003524_st0.fits')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '02may23_betaCrB/NEO_20230503_003617_st0.fits')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '02may23_betaCrB/NEO_20230503_003709_st0.fits')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '02may23_betaCrB/NEO_20230503_003803_st0.fits')
