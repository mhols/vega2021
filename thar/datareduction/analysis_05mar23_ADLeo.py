...
starname = 'ADLeo'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '05mar23_ADLeo/NEO_20230305_183642_th0.fits')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '05mar23_ADLeo/NEO_20230305_230123_st0.fits')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '05mar23_ADLeo/NEO_20230305_231201_st0.fits')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '05mar23_ADLeo/NEO_20230305_232232_st0.fits')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '05mar23_ADLeo/NEO_20230305_233304_st0.fits')
