...
starname = 'betaCrB'
fitsfile_starname = os.path.join(kwargs_reference['BASEDIR'], '07may23_betaCrB/NEO_20230507_194754_th0.fits')
starname_1 = os.path.join(kwargs_reference['BASEDIR'], '07may23_betaCrB/NEO_20230508_005649_st0.fits')
starname_2 = os.path.join(kwargs_reference['BASEDIR'], '07may23_betaCrB/NEO_20230508_005743_st0.fits')
starname_3 = os.path.join(kwargs_reference['BASEDIR'], '07may23_betaCrB/NEO_20230508_005835_st0.fits')
starname_4 = os.path.join(kwargs_reference['BASEDIR'], '07may23_betaCrB/NEO_20230508_005928_st0.fits')
