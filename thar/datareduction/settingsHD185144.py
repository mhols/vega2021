...
RESULTDIR = os.path.abspath(os.path.join(BASEDIR, 'HD185144_res')); comment['REFFILES'] = "Referenzfiles"
...
fitweight = 'equal'                     # flux (total flux of line) weight based on pixel uncertainty of snippet centroid 
