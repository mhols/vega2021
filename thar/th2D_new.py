...
# ici on ecrit le tableau de sortie (i, lam_i, true_ordre_i, posi_i,err_posi_i)
            outtableau1.write("%4d %20.10e %2d %20.10e %20.10e\n" % (linecount, gaussposi1[k], tordernum[j], pixelposi1[k], erreurposi1[k] ))
...
#            plt.show()
            ...
            # ici on ecrit le tableau de sortie (i, lam_i, true_ordre_i, posi_i,err_posi_i)
            outtableau2.write("%15.7f %20.10e %20.10e %20.10e %20.10e\n" % (linecount, gaussposi2[k], tordernum[j], pixelposi2[k], erreurposi2[k] ))
# difference satlasext - gaussposi
